    ...
    <div className="auth-page">
      <div className="auth-branding">
        ...
        >
          <h2 className="auth-brand-quote">
            "InterviewGPT transformed how I prepare. The AI Coach felt like having a senior engineer guiding me through every LeetCode hard."
          </h2>
          <div className="auth-brand-author">
            ...
            <div>
              <div className="font-bold text-white">Alex S.</div>
              <div className="text-sm">Software Engineer @ Google</div>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="auth-content">
        ...
        >
          ...
          <p className="auth-subtitle">Log in to continue your interview prep journey.</p>
